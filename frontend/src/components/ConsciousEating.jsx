...
const ConsciousEating = ({ refreshStats }) => {
  ...
  const checkedCount = Object.values(meals).filter(m => m.value).length;
          ...
          <div className="relative w-8 h-8 flex items-center justify-center flex-shrink-0">
            <svg className="w-8 h-8 transform -rotate-90">
              ...
              <circle
                ...
                strokeDashoffset={75.4 - (checkedCount / 3) * 75.4}
              />
            </svg>
            <span className="absolute text-[0.65rem] font-medium text-text">{checkedCount}/3</span>
          </div>
